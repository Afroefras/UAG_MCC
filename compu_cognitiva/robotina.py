...
class Game:
    def __init__(self, title: str, tile_size: int, tiles_horizontal: int, tiles_vertical: int):
        pg.init()
        ...
        self.start_button = pg.Rect(window_width / 2 - 50, window_height / 2 - 25, 100, 50)
